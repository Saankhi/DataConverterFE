...
export default function MyMappings() {
    ...
    return (
        <>
            <div style={{ float: 'right', margin: '20px 20px' }}>
                <button style={{ backgroundColor: '#12B5B0', width: '200px', height: '50px', borderRadius: '20px', color: "white", border: "none", fontSize: '18px' }} onClick={onHandleClick}>Create New Mapping</button>
            </div>
            <h2 style={{ margin: '50px' }}>My Mappings</h2>
            <div className="container" style={{ overflowY: "scroll", maxHeight: "calc(100vh - 159px)" }}>
                {mappings.length > 0 ? <Table>
                    <thead style={{ border: '1px solid black', borderRadius: '10px' }}>
                        ...
                        <tr>
                            <th style={{ color: '#12B5B0' }}>Input Template Name</th>
                            <th style={{ color: '#12B5B0' }}>Output Template Name</th>
